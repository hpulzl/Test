...
<body class=""> 
  <!--<![endif]-->
    <%
      Testpaper tp = (Testpaper)request.getAttribute("testpaper");
    %>
    <div class="navbar">
...
<div class="btn-toolbar">
    <button class="btn btn-primary" id="saveTestpaper"><i class="icon-save"></i> 保存</button>
    <button id="reloadtestPaper" class="btn">刷新</button>
  <div class="btn-group">
  </div>
</div>
<div class="well">
    ...
    <div id="myTabContent" class="tab-content">
     ...
     <%if(tp!=null){ %>
	    <form id="tab">
	        <label>试卷名称</label>
	        <input type="text" id="testname" value="<%=tp.getTestname() %>" class="span3">
	        <input type="hidden" id="testid" value="<%=tp.getTestid() %>" >
	        <label>试卷题量</label>
	        <input type="text" value="30" readonly="readonly" class="span3">
	        <label>难易程度</label>
	        <select name="difficult" id="difficult" class="input-xlarge">
